...
export async function GET(
  ...
  try {
    ...
    const result = await callExternalApi(`${baseUrl}/v1/bands/names/${encodeURIComponent(decodedName)}/exists`, {
      method: "GET",
      headers: {
    ...
    console.error("Error in band name exists GET route:", error);
    return createApiResponse({
      success: false,
